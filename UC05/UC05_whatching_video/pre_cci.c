# 1 "c:\\perfomance lab\\loadrunner\\\344\353\377 gita\\uc05_whatching_video\\\\combined_UC05_whatching_video.c"
...
# 1 "c:\\perfomance lab\\loadrunner\\\344\353\377 gita\\uc05_whatching_video\\\\combined_UC05_whatching_video.c" 2
...
# 2 "c:\\perfomance lab\\loadrunner\\\344\353\377 gita\\uc05_whatching_video\\\\combined_UC05_whatching_video.c" 2
...
# 3 "c:\\perfomance lab\\loadrunner\\\344\353\377 gita\\uc05_whatching_video\\\\combined_UC05_whatching_video.c" 2
...
# 4 "c:\\perfomance lab\\loadrunner\\\344\353\377 gita\\uc05_whatching_video\\\\combined_UC05_whatching_video.c" 2

# 1 "UC05_whatching_video.c" 1
UC05_whatching_video()
{	
	 
	lrvtc_retrieve_message("Email_client_execute");
	lrvtc_retrieve_message("Order_id_execute");
	...
	web_submit_data("authentication", 
		...
		"EncodeAtSign=YES", 
		"ITEMDATA", 
		"Name=username", "Value={Email_client_execute}", "ENDITEM", 
	...
	web_url("{Order_id_execute}", 
		"URL=https://loadtest.uxcrowd.ru/api/v3/customer/order/{Order_id_execute}", 
		"TargetFrame=", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=https://loadtest.uxcrowd.ru/app-customer-home/tests/{Order_id_execute}", 
		"Snapshot=t26.inf", 
		"Mode=HTML", 
		"LAST");

	web_url("get-tester_task_link", 
		"URL=https://loadtest.uxcrowd.ru/api/server/get-tester_task_link?customerOrderId={Order_id_execute}&targetType=SITE", 
		"TargetFrame=", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=https://loadtest.uxcrowd.ru/app-customer-home/tests/{Order_id_execute}", 
...
# 5 "c:\\perfomance lab\\loadrunner\\\344\353\377 gita\\uc05_whatching_video\\\\combined_UC05_whatching_video.c" 2
...
# 6 "c:\\perfomance lab\\loadrunner\\\344\353\377 gita\\uc05_whatching_video\\\\combined_UC05_whatching_video.c" 2
